...
if(isset($_POST['register'])){
    ...
    if($firstname == '' || $lastname == '' || $email == '' || $password == ''){
        ...
        if($count > 0){
            ...
            $insert_user = "INSERT INTO `user` (firstname, lastname, email, password, date) 
...
<body>
    ...
    <h3 class="text-center mt-3 pt-1">User Registration</h3>
    ...
    <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="button-container">
                <button type="submit" name="register" class="btn btn-secondary" value="Submit">Register</button>
    
                <a class="btn btn-bg" href="userlogin.php">Login</a>
