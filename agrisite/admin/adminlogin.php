...
<body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="../userdetails/userlogin.php">Products</a>
                  </li>
                  <li class="nav-item">
    ...
    <h3 class="text-center mt-3 pt-1">Admin Login</h3>
    <div class="container form-container">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="button-container">
                ...
                <a class="btn btn-bg" href="./adminregistration.php">Register</a>
                <a class="btn btn-bg" href="../userdetails/userlogin.php">User Login</a>
            </div>
            </div>
        </form>
    </div>
